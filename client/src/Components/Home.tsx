...
function JoinMatch() {
    return <div className="flex flex-row w-[65%] md:w-[40%] h-fit justify-center items-center space-x-6">
        <div className="flex flex-col bg-white text-black bg-opacity-90 space-y-1 w-40 h-full rounded-[4px] p-2 items-center text-center text-xs md:text-sm">
            ...
            <Button href="/lobby" sx={{ color: 'black', padding: ['3px', '5px'], fontSize: ['12px'], fontFamily: 'headerFont', border: 'solid black', borderWidth: '1.2px', boxShadow: '4px 4px 10px rgba(0, 0, 0, 0.25)' }}>Join Match</Button>
        </div>
        <div className="flex flex-col space-y-1 bg-white text-black bg-opacity-90 w-40 h-full rounded-[4px] p-2 items-center text-center text-xs md:text-sm">
            ...
            <Button href="/privateLobby" sx={{ color: 'black', padding: ['3px', '5px'], fontSize: ['12px'], fontFamily: 'headerFont', border: 'solid black', borderWidth: '1.2px', boxShadow: '4px 4px 10px rgba(0, 0, 0, 0.25)' }}>Start Match </Button>
        </div>
    </div >
}
