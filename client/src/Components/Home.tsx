...
export default function Home() {
    ...
    return <div className="flex flex-col text-white">
        ...
        <div className="flex justify-center md:h-72 lg:h-80 my-3">
            <JoinMatch />
        </div>
    </div>
}
...
function JoinMatch() {
    ...
    return <div className="flex flex-row w-[65%] md:w-[45%] lg:md:w-[40%] justify-center items-center space-x-6">
        <div className="flex flex-col bg-white text-black bg-opacity-90 w-40 md:w-1/2 h-full rounded-xl py-4 items-center text-center ">
            <p className="font-basicFont text-xs md:text-sm lg:text-lg">Play against anyone</p>
            <div className="flex flex-col items-center">
                <img src={earthIcon} className="w-full md:w-36 lg:w-48"></img>
        ...
        <div className="flex flex-col bg-white text-black bg-opacity-90 w-40 md:w-1/2 h-full rounded-xl py-4 items-center text-center">
            <p className="font-basicFont text-xs md:text-sm lg:text-lg">Play against friends</p>
            <div className="flex flex-col items-center">
                <img src={lockIcon} className="w-full md:w-36 lg:w-48"></img>
